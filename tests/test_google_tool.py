...
def test_google_search_tool_success_response(success_response) -> None:
...
def test_google_search_tool_zero_results(zero_results_response) -> None:
...
def test_google_search_tool_malformed_response() -> None:
...
def test_google_search_tool_logging_sanitization() -> None:
