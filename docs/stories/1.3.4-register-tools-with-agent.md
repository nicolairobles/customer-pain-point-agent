...
- [ ] **Integration Test**: Run agent with each tool enabled individually to confirm compatibility. *(Deferred: Google tool is still stubbed; integration coverage will follow when its implementation lands in a later story.)*
