...
- [ ] **Integration Test**: Run agent with each tool enabled individually to confirm compatibility. *(Deferred: Google/Twitter tools are still stubbed; integration coverage will follow when their implementations land in a later story.)*
